...
| `design/packages/design-system`  | Publishable Material Design 3 colours, tokens, Vuetify themes and component defaults shared by WorldLens-family interfaces                                                      |
...
| `design/packages/ui`             | Material Design 3 Vue UI consuming `@worldlens/design-system`, plus WorldLens-specific behavior and surfaces                                                                     |
