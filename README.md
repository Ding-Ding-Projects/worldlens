...
| **The render console**                     | Annotated live output plus bounded retained-history source, complete-array search, structured export, explicit retention warnings, confirmed selected-line deletion and current-render prune-all; packaged restart/reopen proof and multi-render/configurable-retention controls are still open | [`docs/render-console.md`](docs/render-console.md)                                                                                                                   |
