...
<img src="docs/screenshots/shell-1280x800.png" alt="The Worldlens desktop application on Home: its own Material title bar across the top, the application rail down the left holding Home, Map and Work with search, notifications and settings in its footer, and beside them the question What are you here to do? over a search field, the Make a map card and the catalogue cards for Your maps and Share a map" width="900">
...
| <img src="docs/screenshots/theme-light.png" alt="The Map destination with the light colour scheme selected: the rail, the viewer control bar and a rendered world of forest, bare ground and snow" width="420">      | <img src="docs/screenshots/theme-dark.png" alt="The Map destination with the dark colour scheme selected, at the same camera position; the title bar, rail and control bar are drawn the same either way" width="420">                                      |
| Light scheme                                                                                                   | Dark scheme. **These two are the same view, and that is the point of the pair:** the colour scheme does not reach the map view's chrome in this build, so nothing in frame changes between them |
