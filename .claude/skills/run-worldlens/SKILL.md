...
| `onboard`                                                   | clear the first-run dialog (declines download consent because an agent cannot provide user consent) — run this first |
...
- **A fresh profile opens on a modal 4-step first-run dialog, and the rail is behind it.**
  ...
  Minecraft download consent because an agent cannot provide the user's consent.
