...
| Banner pattern compatibility | Typed, ordered banner layers across supported Minecraft eras, with legacy/current aliases, opaque unknown identifiers, malformed-entry handling, and an exact acceptance boundary | **Implementation and focused fixture proof landed; artifact proof remains open.** Typed data is in `47c3f8a5237f9f5f68c3aea63e92bc6cf13c4c1b`; the focused executable fixture/round-trip proof is in `d14203e7e40a2ae4851b8bfe3476450609451570` (5/5). A real patterned-banner world, oracle render, and packaged-viewer read-back are not yet recorded. See [`design/docs/banner-patterns.md`](docs/banner-patterns.md) and the 2026-08-19 handoff entry. |
