...
const RECORDS: readonly CaptureRecord[] = [
    ...
    },
    {
        ...
        aspectRatio: "8 / 5",
        title: "Failed cloud renders after restart",
        configuration: "1280 by 800, current build reopened through Lowlevel MCP",
        alt: "Worldlens cloud-render history after restart: two persisted rows are labelled failed, each reports the real failed run and offers Remove from list instead of displaying an endless spinner.",
        featured: true,
    },
    {
        file: "lowlevel-ci-render-remove-confirmation.png",
        aspectRatio: "8 / 5",
        title: "Removing one failed local row",
        configuration: "1280 by 800, two-key super confirmation",
        alt: "Worldlens two-key confirmation explaining that removing a failed cloud-render row deletes only local history and leaves the GitHub run, release and rendered files untouched.",
        featured: false,
    },
    {
        file: "lowlevel-ci-render-row-removed.png",
        aspectRatio: "8 / 5",
        title: "Failed local row removed",
        configuration: "1280 by 800, after full confirmation",
        alt: "Worldlens cloud-render history after one failed local row was removed through the complete confirmation; two failed rows remain with their real outcomes and controls.",
        featured: false,
    },
];
