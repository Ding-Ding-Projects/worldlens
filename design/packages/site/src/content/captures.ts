...
const RECORDS: readonly CaptureRecord[] = [
    ...
    {
        file: "lowlevel-kid-first-run-welcome.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode first run",
        configuration: "1280 by 800, fresh isolated profile, Lowlevel MCP input",
        alt: "Worldlens Kid Mode with the real first-run welcome dialog open over the fresh Home screen on an isolated profile.",
        featured: false,
    },
    {
        file: "lowlevel-kid-first-run-licence.png",
        aspectRatio: "8 / 5",
        title: "Licence review through real keyboard input",
        configuration: "1280 by 800, Lowlevel Page Down input",
        alt: "Worldlens first-run licence review after a real background Page Down key exposed the Next action at the bottom of the document.",
        featured: false,
    },
    {
        file: "lowlevel-kid-first-run-consent.png",
        aspectRatio: "8 / 5",
        title: "Download consent before accepting",
        configuration: "1280 by 800, fresh isolated profile",
        alt: "Worldlens first-run Minecraft download decision showing both Accept and Decline before the automated run chooses Accept.",
        featured: false,
    },
    {
        file: "lowlevel-kid-first-run-storage.png",
        aspectRatio: "8 / 5",
        title: "Map storage setup",
        configuration: "1280 by 800, download consent accepted",
        alt: "Worldlens first-run map storage step with its default folder and Finish setup action after download consent was accepted.",
        featured: false,
    },
    {
        file: "lowlevel-kid-home.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode Home through real UI input",
        configuration: "1280 by 800, Lowlevel MCP hidden desktop",
        alt: "Worldlens Kid Mode Home with its five catalogue lands, large navigation rail, current activity list, and maps and servers panel.",
        featured: true,
    },
    {
        file: "lowlevel-kid-explore-empty.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode Explore empty state",
        configuration: "1280 by 800, no map loaded",
        alt: "Worldlens Kid Mode Explore showing the honest no-map-loaded state after a real click on the Explore rail control.",
        featured: false,
    },
    {
        file: "lowlevel-kid-jobs.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode jobs",
        configuration: "1280 by 800, fresh workspace",
        alt: "Worldlens Kid Mode jobs workspace reached through the third large rail control on a fresh profile.",
        featured: false,
    },
    {
        file: "lowlevel-kid-stickers.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode sticker book",
        configuration: "1280 by 800, fresh empty progress",
        alt: "Worldlens Kid Mode sticker book showing its genuine fresh-profile empty progress state.",
        featured: false,
    },
    {
        file: "lowlevel-kid-grown-up-gate.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode grown-up gate",
        configuration: "1280 by 800, no grown-up code configured",
        alt: "Worldlens Kid Mode grown-up gate explaining that no code is configured and offering the visible route to Adult Mode.",
        featured: true,
    },
    {
        file: "lowlevel-adult-map-empty.png",
        aspectRatio: "8 / 5",
        title: "Adult Mode after the mode switch",
        configuration: "1280 by 800, dark theme, no map loaded",
        alt: "Worldlens Adult Mode Map immediately after the grown-up gate switches away from Kid Mode.",
        featured: false,
    },
    {
        file: "lowlevel-adult-home.png",
        aspectRatio: "8 / 5",
        title: "Adult Mode Home through real UI input",
        configuration: "1280 by 800, dark theme, Lowlevel MCP hidden desktop",
        alt: "Worldlens Adult Mode Home with the application rail, search, Make a map card, tour, and expandable feature sections.",
        featured: true,
    },
    {
        file: "lowlevel-adult-settings.png",
        aspectRatio: "8 / 5",
        title: "Adult Mode Settings",
        configuration: "1280 by 800, docked settings panel",
        alt: "Worldlens Adult Mode Settings opened from the rail, showing the settings search, section tabs, and download-consent row.",
        featured: false,
    },
    {
        file: "lowlevel-adult-kid-mode-settings.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode and Adult Mode settings",
        configuration: "1280 by 800, Adult Mode settings tab",
        alt: "Worldlens settings on the Kid Mode and Adult Mode tab with Adult Mode selected and the Kid Mode option ready to choose.",
        featured: true,
    },
    {
        file: "lowlevel-kid-returned-from-settings.png",
        aspectRatio: "8 / 5",
        title: "Kid Mode restored from Adult settings",
        configuration: "1280 by 800, Kid Mode selected through the real radio control",
        alt: "Worldlens returned to Kid Mode after the visible Kid Mode radio control was selected in Adult settings, with the dock remaining open on the same section.",
        featured: true,
    },
    {
        file: "lowlevel-ci-render-history-fixed.png",
        aspectRatio: "8 / 5",
        title: "Cancelled cloud render after restart",
        configuration: "1280 by 800, current build reopened through Lowlevel MCP",
        alt: "Worldlens cloud-render history after restart: a stopped-watching run is labelled cancelled and offers Remove from list instead of displaying an endless spinner.",
        featured: true,
    },
    {
        file: "lowlevel-ci-render-remove-confirmation.png",
        aspectRatio: "8 / 5",
        title: "Removing one cancelled local row",
        configuration: "1280 by 800, two-key super confirmation",
        alt: "Worldlens two-key confirmation explaining that removing a cancelled cloud-render row deletes only local history and leaves the GitHub run, release and rendered files untouched.",
        featured: false,
    },
    {
        file: "lowlevel-ci-render-row-removed.png",
        aspectRatio: "8 / 5",
        title: "Cancelled local row removed",
        configuration: "1280 by 800, after full confirmation",
        alt: "Worldlens cloud-render history after the cancelled local row was removed through the complete confirmation, leaving the honest empty state.",
        featured: false,
    },
    {
        file: "issue-180-rail-more-open.png",
        aspectRatio: "32 / 15",
        title: "The rail's More control, open",
        configuration: "1280 by 600, packaged release 1.0.2035 driven on a hidden desktop",
        alt: "The application rail at a window too short to hold every job shortcut, with the More control pressed: an anchored menu is open beside the rail, a filter field at its head and six overflowed shortcuts listed below it.",
        featured: false,
    },
    {
        file: "issue-180-rail-long-label-wrap.png",
        aspectRatio: "8 / 5",
        title: "A longer shortcut label wraps",
        configuration: "1280 by 800, packaged release 1.0.2035 with a personal-vocabulary file loaded",
        alt: "The application rail with one shortcut label replaced by a twelve-character word, which renders across two lines in a row that grew to hold it, with no ellipsis and no dropped characters.",
        featured: false,
    },
    {
        file: "issue-181-convert-source-actions-enabled.png",
        aspectRatio: "8 / 5",
        title: "Both folder actions on the source step",
        configuration: "1280 by 800, packaged release 1.0.2035 driven on a hidden desktop",
        alt: "The Convert screen's source step with Browse for a world folder and Mount another Minecraft folder both rendered as live tonal buttons, and no unmet-condition line under either of them.",
        featured: false,
    },
    {
        file: "issue-182-convert-converter-provenance.png",
        aspectRatio: "8 / 5",
        title: "The converter this installer carries",
        configuration: "1280 by 800, packaged release 1.0.2035 driven on a hidden desktop",
        alt: "The Convert screen's target step reporting converter version 1.19.1 and the SHA-256 of the jar it resolved, with no not-installed warning and no fetch control beside it.",
        featured: false,
    },
    {
        file: "issue-183-convert-destination-picker.png",
        aspectRatio: "8 / 5",
        title: "Where a conversion can run",
        configuration: "1280 by 800, packaged release 1.0.2035 signed out of every hosted account",
        alt: "The Convert screen's destination picker: this computer selected, a local container selectable, and the hosted-runner, SSH and Amazon destinations held unselectable, each stating its unmet condition and offering the action that would meet it.",
        featured: false,
    },
    {
        file: "issue-183-convert-review-local-destination.png",
        aspectRatio: "8 / 5",
        title: "The review step with no other destination's section",
        configuration: "1280 by 800, packaged release 1.0.2035 with this computer chosen",
        alt: "The Convert screen's review step with this computer as the destination, rendering neither the local-container section nor the hosted-runner section.",
        featured: false,
    },
    {
        file: "issue-183-convert-container-memory-field.png",
        aspectRatio: "8 / 5",
        title: "The container section's memory limit",
        configuration: "1280 by 800, packaged release 1.0.2035 with the local container chosen",
        alt: "The Convert screen's review step showing only the local-container section, where the Refresh available choices button and the outlined Container memory limit field are separated and the field's floating label sits clear of the button.",
        featured: false,
    },
    {
        file: "issue-183-convert-container-memory-field-320.png",
        aspectRatio: "2 / 5",
        title: "The same section at 320 pixels wide",
        configuration: "320 by 800, packaged release 1.0.2035 with the local container chosen",
        alt: "The local-container section of the Convert screen at the narrowest supported width, with the Refresh available choices button and the Container memory limit field still separated and the section copy reflowing rather than clipping.",
        featured: false,
    },
];
