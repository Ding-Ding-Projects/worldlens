...
export const REQUIRED_PAGES_FEATURE_IDS = [
    ...
    "searchable-categorized-capture-gallery",
    "startup-dim-sum",
...
export const PAGES_FEATURE_COVERAGE: readonly PagesFeatureCoverage[] = [
    ...
    implemented(
        "searchable-categorized-capture-gallery",
        "Complete evidence-backed capture gallery with categories and anchored regex search",
        [
            "design/packages/site/index.html",
            "design/packages/site/scripts/archive-site-plugin.mjs",
            "design/packages/site/package.json",
            "design/packages/site/src/content/screenshotGallery.ts",
            "design/packages/site/src/shots/CaptureGallery.ts",
            "design/packages/site/src/main.ts",
            "design/packages/site/src/content/content.css",
            "design/packages/site/src/i18n/strings.ts",
            "design/packages/site/src/content/articles/screenshot-gallery.ts",
        ],
        [
            "design/packages/site/scripts/assert-screenshot-gallery.mjs",
            "design/packages/site/src/content/screenshotGallery.test.ts",
            "design/packages/site/src/shots/CaptureGallery.test.ts",
            "design/packages/site/src/policy/globalFeatureCoverage.test.ts",
