...
export interface ConverterQueueDraft { readonly id: string; readonly source: string; readonly target: string; readonly adapterId: string; readonly bytes: number | null; readonly operation?: string; readonly pdfRequest?: Readonly<Record<string, unknown>>; }
export interface ConverterQueueItem extends ConverterQueueDraft { readonly state: string; readonly progress: number; readonly message: string | null; readonly updatedAt: string; readonly result?: Readonly<Record<string, unknown>>; }
