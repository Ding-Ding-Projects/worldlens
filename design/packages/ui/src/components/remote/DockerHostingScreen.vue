                    ...
                    <v-card class="mb-docker-hosting__create" variant="outlined">
                        ...
                        <v-card-text>
                            ...
                            <div class="mb-docker-hosting__create-grid">
                                <v-text-field v-model="createId" :label="t('dockerHosting.create.id', 'Instance id')" :error-messages="createIdError ?? null" :disabled="createBusy" autocomplete="off" />
                                <v-text-field v-model="createName" :label="t('dockerHosting.create.name', 'Display name')" :error-messages="createNameError ?? null" :disabled="createBusy" autocomplete="off" />
                                ...
                                <v-text-field v-model="createImageFree" :label="t('dockerHosting.create.imageFree', 'Or enter an exact digest-pinned image')" :error-messages="createImageError ?? null" :disabled="createBusy" autocomplete="off" />
                                <v-text-field v-model="createPorts" :label="t('dockerHosting.create.ports', 'Loopback ports')" :hint="t('dockerHosting.create.portsHint', 'Optional comma-separated ports; Docker binds each one to 127.0.0.1 only.')" :error-messages="createPortsError ?? null" persistent-hint :disabled="createBusy" autocomplete="off" />
                                ...
                                <v-text-field v-model="createVolumesFree" :label="t('dockerHosting.create.volumeFree', 'Or enter owned volume names')" :hint="t('dockerHosting.create.volumeFreeHint', 'Optional comma-separated names; each must begin with worldlens-.')" :error-messages="createVolumesError ?? null" persistent-hint :disabled="createBusy" autocomplete="off" />
                            </div>
