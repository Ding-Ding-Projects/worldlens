/**
 * material-exempt: a table describing which CSS properties the typography editor emits, and the value each carries. It is a specification of behaviour rather than styling applied to anything.
 */
/**
