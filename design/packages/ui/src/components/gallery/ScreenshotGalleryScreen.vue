...
.mb-screenshot-gallery__card img { display: block; width: 100%; aspect-ratio: 16 / 10; object-fit: contain; background: var(--md-sys-color-surface-container-highest); } .mb-screenshot-gallery__select { display: block; padding: 10px; } .mb-screenshot-gallery__card-body { padding: 14px; } .mb-screenshot-gallery__card-body h2 { font-size: 1.1rem; margin: 0 0 6px; } dl { display: grid; grid-template-columns: max-content 1fr; gap: 4px 10px; font-size: .82rem; } dt { font-weight: 700; } dd { margin: 0; overflow-wrap: anywhere; } .mb-screenshot-gallery__tags { opacity: .75; }
