...
export const CONVERTER_VOICED = {
    "converter.overline": { en: ["Local file tools", "Local file tools, ready", "Local file tools, nice and tidy", "Local file tools, no mystery bytes", "Local file tools, byte buffet time"], yue: ["本機檔案工具", "本機檔案工具，準備好喇", "本機檔案工具，整整齊齊", "本機檔案工具，唔畀位元組玩失蹤", "本機檔案工具，位元組自助餐開波"] },
    "converter.title": { en: ["Convert files safely", "Convert files safely and clearly", "Convert files safely, with fewer surprises", "Convert files safely, while the bytes behave", "Convert files safely, because byte soup is not dinner"], yue: ["安全咁轉換檔案", "安全咁轉換檔案，清清楚楚", "安全咁轉換檔案，少啲驚喜", "安全咁轉換檔案，等位元組乖乖聽話", "安全咁轉換檔案，位元組湯唔係晚餐"] },
} as const;
