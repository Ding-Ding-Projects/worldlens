...
export const PALETTE_VOICED = {
    ...
    "palette.row.location": {
        en: [
            ...
            "Location",
            "Where it lives",
            "Where this little control lives",
        ],
    ...
    "palette.row.addFavourite": {
        en: [
            ...
            "Add {title} to favourites",
            "Add {title} to favourites",
            "Keep {title} in favourites",
            "Pin {title} here so it stops hiding",
        ],
        yue: [
            "將 {title} 加入最愛",
            "將 {title} 加入最愛",
    ...
    "palette.row.removeFavourite": {
        en: [
            ...
            "Remove {title} from favourites",
            "Remove {title} from favourites",
            "Take {title} out of favourites",
            "Send {title} out of favourites for a little holiday",
        ],
        yue: [
            "由最愛移除 {title}",
            "由最愛移除 {title}",
    ...
    "palette.choice.menuLabel": {
        en: [
            ...
            "{title} options",
            "Choices for {title}",
            "The many little choices for {title}",
        ],
        yue: [
            "{title} 選項",
            "{title} 選項",
    ...
    "palette.choice.searchLabel": {
        en: [
            ...
            "Search {title} options",
            "Find a {title} option",
            "Find the exact {title} choice hiding in this little menu",
        ],
        yue: [
            "搜尋 {title} 選項",
            "搜尋 {title} 選項",
            "搜尋 {title} 選項",
            "搵 {title} 選項",
            "喺呢張細選單搵返啱啱好嘅 {title} 選擇",
        ],
    },
    "palette.directory.tab": {
        en: [
            "An open tab in the live workspace.",
            "An open tab in the live workspace.",
            "An open tab in the live workspace.",
            "An open tab in the live workspace.",
            "An open tab in the live workspace, still doing its job.",
        ],
        yue: [
            "目前工作區開緊嘅分頁。",
            "目前工作區開緊嘅分頁。",
    ...
    "palette.directory.tabGroup": {
        en: [
            "A live tab group in the workspace.",
            "A live tab group in the workspace.",
            "A live tab group in the workspace.",
            "A named tab group in the workspace.",
            "A named tab group keeping its tab family together.",
        ],
        yue: [
            "工作區目前嘅分頁群組。",
            "工作區目前嘅分頁群組。",
    ...
    "palette.directory.article": {
        en: [
            "A bundled offline documentation article.",
            "A bundled offline documentation article.",
            "A bundled offline documentation article.",
            "An offline article bundled with the app.",
            "An offline article that stayed home and brought its own words.",
        ],
        yue: [
            "內置嘅離線文件文章。",
            "內置嘅離線文件文章。",
    ...
    "palette.directory.appearanceDescription": {
        en: [
            ...
            "Adjust the appearance of the live interface.",
            "Adjust the appearance of the live interface.",
            "Adjust the live interface appearance.",
            "Tune the live interface until it behaves itself visually.",
        ],
        yue: [
            "調整目前介面嘅外觀。",
            "調整目前介面嘅外觀。",
    ...
    "palette.directory.recoveryDescription": {
        en: [
            ...
            "Find retry, support, and recovery routes.",
            "Find retry, support, and recovery routes.",
            "Find retry, support, and recovery routes here.",
            "The sensible exits for when a feature has stepped on a rake.",
        ],
        yue: [
            "搵重試、支援同復原路線。",
            "搵重試、支援同復原路線。",
    ...
    "palette.where.tab": {
        en: [
            ...
            "Focuses the {tab} tab.",
            "Focuses the {tab} tab.",
            "Jumps to the {tab} tab.",
            "Flies straight to the {tab} tab.",
        ],
        yue: [
            "聚焦 {tab} 分頁。",
            "聚焦 {tab} 分頁。",
    ...
    "palette.where.tabGroup": {
        en: [
            ...
            "Focuses the first available tab in this group.",
            "Focuses the first available tab in this group.",
            "Jumps to the first tab in this group.",
            "Jumps into the first tab in this group, where the tab family is waiting.",
        ],
        yue: [
            "聚焦呢個群組第一個可用分頁。",
            "聚焦呢個群組第一個可用分頁。",
    ...
    "palette.where.article": {
        en: [
            ...
            "Opens the {article} article.",
            "Opens the {article} article.",
            "Opens the {article} article directly.",
            "Opens the {article} article, no paper hunt required.",
        ],
        yue: [
            "打開 {article} 文章。",
            "打開 {article} 文章。",
    ...
    "palette.where.catalogueFeature": {
        en: [
            ...
            "Opens this feature through its existing catalogue route.",
            "Opens this feature through its existing catalogue route.",
            "Opens this feature through the existing catalogue route.",
            "Uses the existing catalogue route, so navigation does not grow a second head.",
        ],
        yue: [
            "經現有目錄路線打開呢個功能。",
            "經現有目錄路線打開呢個功能。",
    ...
    "palette.where.appearance": {
        en: [
            "Opens the appearance settings surface.",
            "Opens the appearance settings surface.",
            "Opens the appearance settings surface.",
            "Opens appearance settings directly.",
            "Opens the appearance settings, where every little visual knob lives.",
        ],
        yue: [
            "打開外觀設定介面。",
            "打開外觀設定介面。",
    ...
    "palette.where.recovery": {
        en: [
            "Opens the Support Tickets recovery surface.",
            "Opens the Support Tickets recovery surface.",
            "Opens the Support Tickets recovery surface.",
            "Opens the Support Tickets recovery surface directly.",
            "Opens Support Tickets, the app's sensible little emergency desk.",
        ],
        yue: [
            "打開支援票復原介面。",
            "打開支援票復原介面。",
...
export const PALETTE_FACTS = {
    ...
    "palette.row.location": {
        en: ["Location || Where it lives || control lives"],
        yue: ["位置 || 喺邊度"],
    },
    "palette.row.related": {
        en: ["Related actions || Useful next actions || handy things"],
        yue: ["相關操作 || 下一步"],
    },
    "palette.row.suggestedNext": {
        en: ["Suggested next || Useful next || Next little thing"],
        yue: ["建議下一步 || 有用嘅下一步 || 下一步可以試"],
    },
    "palette.row.addFavourite": {
        en: ["{title}", "favourites || Pin"],
        yue: ["{title}", "最愛"],
    },
    ...
    "palette.choice.searchLabel": {
        en: ["{title}", "options || option || choice"],
        yue: ["{title}", "選項 || 選擇"],
    },
    "palette.directory.tab": { en: ["open tab"], yue: ["開緊嘅分頁"] },
    "palette.directory.tabGroup": { en: ["tab group"], yue: ["群組"] },
    "palette.directory.article": { en: ["article"], yue: ["文章"] },
    "palette.directory.appearanceDescription": {
        en: ["appearance || visually"],
        yue: ["外觀 || 個介面嘅樣"],
    },
    "palette.directory.recoveryDescription": {
        en: ["recovery || exits"],
