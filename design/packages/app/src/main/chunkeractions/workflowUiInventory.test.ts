 ...
 * from `workflowDrift.test.ts` rather than reimplemented here: it is a local check that
 * GitHub Actions never runs, so the only thing that runs it at all is this suite.
 */
