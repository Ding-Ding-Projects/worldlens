...
import { assertConverterCompleteness, buildAdapterRegistry, CONVERTER_CATEGORIES, detectAdapter, KNOWN_ADAPTERS, validateAdapterRegistry, type ConverterAdapter } from "./registry.js";
...
describe("converter registry", () => {
    it("detects byte signatures rather than trusting a filename", async () => {
        ...
        expect(detectAdapter(new Uint8Array([0x4e, 0x4f, 0x50, 0x45]), registry)).toBeNull();
    });
